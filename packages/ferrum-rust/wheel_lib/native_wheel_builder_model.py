"""Models, constants, and publication adapters for native wheel construction."""
...
from wheel_lib.native_wheel_adapter_abi import adapter_abi_version_from_header
from wheel_lib.native_wheel_output_root import engine_bundle_path as admitted_engine_bundle_path
from wheel_lib.native_wheel_output_root import output_path as admitted_output_path
from wheel_lib.native_wheel_profile import FERRUM_RDKIT_PROFILE, MACHINE_RESULT_SCHEMA
from wheel_lib.native_wheel_receipt import NativeReceiptError, sha256, validate_native_input_manifest
...
FERRUM_SOURCE_CLOSURE_EXCLUDED_DIRECTORIES = (
	...
	"crates/api/python/ferrum-engine-bundle",
)
