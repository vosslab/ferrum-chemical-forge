...
M16 A2b accepts a closed no-substituent direct-glycosidic Haworth receipt with
one finite anchor. Preparation and atomic commit retain canonical durable
authored facts and the exact accepted document observation.

Stage B accepts one in-process API composition from that committed receipt. It
derives the same closed render observation from the embedded observation, not
from a session re-observation. It authenticates source `PersistentId` through
...
The accepted direct style follows the operation drawing standard for paint and
line width; `standard/bond@wedge-width` uses the source-backed 5px fallback
only when that fact is absent.
...
backends, not a gate for Stage B.
...
- `/private/tmp/review_m16_haworth_a2b_final_20260813.md`
- `/private/tmp/review_m16_haworth_composite_renderer_20260813.md`
- `/private/tmp/review_m16_haworth_composite_api_20260813.md`
- `/private/tmp/design_m16_haworth_composite_style_20260813.md`
