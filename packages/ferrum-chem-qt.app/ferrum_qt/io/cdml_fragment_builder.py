...
def build_top_level_fragment(
		document: ferrum_qt.models.document.Document, objects: list[object],
		) -> str:
...
def _serialize_object(
	...
	if isinstance(obj, ferrum_qt.models.molecule_model.MoleculeModel):
		return _serialize_molecule(result, obj, document)
	presentation = obj
	if not isinstance(presentation, ferrum_qt.models.document_object.PresentationObject):
...
def _serialize_molecule(
	...
	oasa_molecule = ferrum_qt.bridge.oasa_bridge.qt_mol_to_oasa_mol(mol_model)
...
def _document_cdml_ids(
		document: ferrum_qt.models.document.Document,
		exclude_molecule: ferrum_qt.models.molecule_model.MoleculeModel | None = None,
		) -> set[str]:
...
def _serialize_reaction(
		result: dom.Document,
		reaction: ferrum_qt.models.document_object.ReactionRecord,
		) -> dom.Element:
