...
use ferrum_document::{
    ...
    publish_document_molecule_smiles_v1 as publish_smiles_receipt, DocumentMoleculeSmilesErrorV1,
    DocumentMoleculeSmilesPublicationErrorV1, DocumentMoleculeSmilesRequestV1,
