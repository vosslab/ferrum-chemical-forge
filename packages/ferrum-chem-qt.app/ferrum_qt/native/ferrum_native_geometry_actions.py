"""Compose native root transforms and molecule repairs for the public window."""

# local repo modules
import ferrum_qt.native.ferrum_native_geometry_repair
import ferrum_qt.native.ferrum_native_top_level_transform


#============================================
class FerrumNativeGeometryActionsMixin(
		ferrum_qt.native.ferrum_native_top_level_transform.FerrumNativeTopLevelTransformMixin,
		ferrum_qt.native.ferrum_native_geometry_repair.FerrumNativeGeometryRepairWindowMixin,
		):
