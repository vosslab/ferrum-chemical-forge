...
use ferrum_document::{
    DocumentObjectIdV1, MoleculeProjectionV1, PresentationTargetV1, SessionDocumentObservationV1,
};
use ferrum_render::{
    DocumentContentBoundsErrorV1, DocumentRenderArtifactV1, DocumentRenderIdentityV1,
    DocumentRenderOutcomeV1, DocumentRenderPlanV1, RenderViewportV1, SvgDocumentV1,
    SvgOutputBudgetV1, SvgRenderError, fit_document_render_plan_to_content_v1,
...
pub fn render_document_selection_to_svg_v1(
    ...
    let render_observation =
        crate::render_observation_v1::derive_render_observation_from_accepted_operation_v1(
            observation,
        )?;
    let complete_plan = compose_document_render_plan_v1(&render_observation)?;
