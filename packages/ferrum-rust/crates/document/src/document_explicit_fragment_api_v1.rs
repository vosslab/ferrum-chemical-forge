...
#[derive(Debug, Error)]
pub enum DocumentExplicitFragmentApiErrorV1 {
    #[error(transparent)]
...
) -> Result<DocumentExplicitFragmentCreateResultV1, DocumentExplicitFragmentApiErrorV1> {
...
pub fn inspect_document_explicit_fragments_v1(
    ...
    expected_revision: u64,
    expected_digest: [u8; 32],
) -> Result<DocumentExplicitFragmentObservationReceiptV1, DocumentExplicitFragmentApiErrorV1> {
