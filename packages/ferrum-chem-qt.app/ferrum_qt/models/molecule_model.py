...
class MoleculeModel(PySide6.QtCore.QObject):
	...
	def __init__(self, parent: PySide6.QtCore.QObject | None = None) -> None:
		...
		self._atom_models: list[ferrum_qt.models.atom_model.AtomModel] = []
		self._bond_models: list[ferrum_qt.models.bond_model.BondModel] = []
		# metadata properties
		self._name = ""
		self._mol_id = ""
		...
		self._fragments: list[ferrum_qt.models.fragment_model.FragmentModel] = []
		...
		self._groups: list[ferrum_qt.models.group_model.GroupModel] = []
	...
	#============================================
	@property
	def fragments(self) -> tuple[ferrum_qt.models.fragment_model.FragmentModel, ...]:
	...
	#============================================
	@property
	def groups(self) -> tuple[ferrum_qt.models.group_model.GroupModel, ...]:
		"""Return ordered native CDML group pseudo-vertices for this molecule."""
		return tuple(self._groups)

	#============================================
	def add_group(self, group: ferrum_qt.models.group_model.GroupModel) -> None:
	...
	#============================================
	def add_fragment(self, fragment: ferrum_qt.models.fragment_model.FragmentModel) -> None:
	...
	def remove_fragment(self, fragment_id: str) -> tuple[
			int, ferrum_qt.models.fragment_model.FragmentModel,
			]:
	...
	#============================================
	def can_add_fragment(self, fragment: ferrum_qt.models.fragment_model.FragmentModel) -> bool:
	...
	#============================================
	def fragment_snapshot(self) -> tuple[ferrum_qt.models.fragment_model.FragmentModel, ...]:
		"""Return a durable ordered fragment snapshot for structural undo."""
		return tuple(self._fragments)

	#============================================
	def restore_fragment_snapshot(
			self, snapshot: tuple[ferrum_qt.models.fragment_model.FragmentModel, ...],
			) -> None:
		"""Restore a previously valid snapshot after undo restores graph objects."""
		self._fragments = list(snapshot)

	#============================================
	def prune_invalid_fragments(self) -> tuple[ferrum_qt.models.fragment_model.FragmentModel, ...]:
	...
	def linear_fragment_snapshot_after_geometry(
			...
			) -> tuple[ferrum_qt.models.fragment_model.FragmentModel, ...]:
	...
	#============================================
	def _fragment_is_valid(self, fragment: ferrum_qt.models.fragment_model.FragmentModel) -> bool:
	...
	def _linear_fragment_is_current(
			self, fragment: ferrum_qt.models.fragment_model.FragmentModel,
	...
	#============================================
	def add_atom(self, atom_model: ferrum_qt.models.atom_model.AtomModel) -> None:
		"""Add an atom to this Qt topology projection.

		Args:
			atom_model: AtomModel to add.
		"""
		if not isinstance(atom_model, ferrum_qt.models.atom_model.AtomModel):
	...
	#============================================
	def remove_atom(self, atom_model: ferrum_qt.models.atom_model.AtomModel) -> None:
	...
	#============================================
	def add_bond(self, atom1_model: ferrum_qt.models.atom_model.AtomModel,
					atom2_model: ferrum_qt.models.atom_model.AtomModel,
					bond_model: ferrum_qt.models.bond_model.BondModel) -> None:
		...
		"""
		if not isinstance(atom1_model, ferrum_qt.models.atom_model.AtomModel):
			raise TypeError("atom1_model must be an AtomModel")
		if not isinstance(atom2_model, ferrum_qt.models.atom_model.AtomModel):
			raise TypeError("atom2_model must be an AtomModel")
		if not isinstance(bond_model, ferrum_qt.models.bond_model.BondModel):
	...
	#============================================
	def remove_bond(self, bond_model: ferrum_qt.models.bond_model.BondModel) -> None:
...
# Graph queries
	...
	def connected_display_atoms(
			...
			) -> tuple[tuple[ferrum_qt.models.atom_model.AtomModel, int], ...]:
	...
	def _breadth_first_parents(
			self,
			root: ferrum_qt.models.atom_model.AtomModel,
			neighbors: dict[
				ferrum_qt.models.atom_model.AtomModel,
				list[tuple[
					ferrum_qt.models.atom_model.AtomModel,
			...
			atom_positions: dict[ferrum_qt.models.atom_model.AtomModel, int],
			) -> dict[
				ferrum_qt.models.atom_model.AtomModel,
				tuple[
					ferrum_qt.models.atom_model.AtomModel | None,
					ferrum_qt.models.bond_model.BondModel | None,
					],
				]:
	...
	def _cycle_from_tree_edge(
			self,
			atom1: ferrum_qt.models.atom_model.AtomModel,
			atom2: ferrum_qt.models.atom_model.AtomModel,
			parents: dict[
				ferrum_qt.models.atom_model.AtomModel,
				tuple[
					ferrum_qt.models.atom_model.AtomModel | None,
				...
				list[ferrum_qt.models.atom_model.AtomModel],
				list[ferrum_qt.models.bond_model.BondModel],
				]:
	...
	def _cycle_edge_mask(
			self,
			tree_bonds: list[ferrum_qt.models.bond_model.BondModel],
			closing_bond: ferrum_qt.models.bond_model.BondModel,
			bond_positions: dict[ferrum_qt.models.bond_model.BondModel, int],
			) -> int:
	...
	def get_smallest_independent_cycles(
			self,
			) -> list[tuple[ferrum_qt.models.atom_model.AtomModel, ...]]:
	...
	#============================================
	def create_atom(self, symbol: str = "C") -> ferrum_qt.models.atom_model.AtomModel:
		...
		"""
		atom_model = ferrum_qt.models.atom_model.AtomModel.create(symbol=symbol)
		return atom_model
	...
	def create_bond(
		...
		"""
		bond_model = ferrum_qt.models.bond_model.BondModel.create(
