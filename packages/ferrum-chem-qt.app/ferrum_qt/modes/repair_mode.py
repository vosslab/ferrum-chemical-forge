...
_REPAIR_HANDLERS = {
	'normalize-lengths': ferrum_qt.actions.repair_actions._handle_normalize_bond_lengths,
	'normalize-angles': ferrum_qt.actions.repair_actions._handle_normalize_bond_angles,
	'normalize-rings': ferrum_qt.actions.repair_actions._handle_normalize_rings,
	'straighten': ferrum_qt.actions.repair_actions._handle_straighten_bonds,
	'snap-hex': ferrum_qt.actions.repair_actions._handle_snap_to_hex_grid,
	'clean': ferrum_qt.actions.repair_actions._handle_clean_geometry,
}
...
#============================================
class RepairMode(ferrum_qt.modes.base_mode.BaseMode):
