...
use crate::publish_document_molecule_inchi_v1;
...
use super::{
    ...
    prepare_document_molecule_inchi_v1,
};
...
fn observation_and_id(source: &str) -> (crate::SessionDocumentObservationV1, DocumentObjectIdV1) {
