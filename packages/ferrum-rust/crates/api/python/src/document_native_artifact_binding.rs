...
use crate::document_error_binding::publication_error;
use crate::document_ingress_binding::PyLocalDocumentOriginTokenV1;
        ...
        Some(origin) => Some(match origin.try_clone_source() {
            ...
            Err(error) => {
                return Err(publication_error(
                    py,
                    crate::binding::PublicationNotStartedError::new_err,
                    destination.clone(),
                    format!(
