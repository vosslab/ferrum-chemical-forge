...
use crate::smiles_insertion_binding::{
...
fn map_build_error(
    ...
    match error {
        ...
        SdfMoleculeBuildError::Geometry(error) => Ok(crate::geometry_binding::geometry_error(
            py,
            error.to_string(),
        )),
        SdfMoleculeBuildError::Position(error) => crate::binding::projection_error(py, error),
