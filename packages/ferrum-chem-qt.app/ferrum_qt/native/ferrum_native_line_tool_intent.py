"""Shared immutable state for native revision-bound pointer gestures."""
...
class _LineGestureIntent:
	...
	drawing: ferrum_qt.native.ferrum_native_drawing_parameters.FerrumNativeDrawingParametersSnapshot | None = None
	...
	rotation_selection: ferrum_qt.native.ferrum_native_rotation.FerrumNativeRotationSelection | None = None
	rotation_preview: ferrum_qt.native.ferrum_native_rotation.FerrumNativeRotationPreview | None = None
	translation_selection: ferrum_qt.native.ferrum_native_translation.FerrumNativeTranslationSelection | None = None
	translation_preview: ferrum_qt.native.ferrum_native_translation.FerrumNativeTranslationPreview | None = None
