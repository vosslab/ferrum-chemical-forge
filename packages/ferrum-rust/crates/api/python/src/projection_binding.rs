...
use crate::atom_mark_binding::PyAtomMarkKindV1;
use crate::binding::PyDocumentBondOrderV1;
...
/// One supported normal, non-spline direct-root arrow projection.
...
impl From<&ArrowProjectionV1> for PyArrowProjectionV1 {
    fn from(value: &ArrowProjectionV1) -> Self {
        Self {
            ...
            axis_path: value.axis_path().into(),
            head_shape: value.head_shape().into(),
            start_head: value.start_head(),
            end_head: value.end_head(),
