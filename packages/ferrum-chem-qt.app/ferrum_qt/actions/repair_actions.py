"""Repair menu action registrations for Ferrum-Qt."""
...
def _submit_geometry_repair(
		...
		target_molecule: ferrum_qt.models.molecule_model.MoleculeModel | None = None,
	...
	if target_molecule_id is not None:
		...
		selected = tuple(
			...
			if isinstance(object_model, ferrum_qt.models.molecule_model.MoleculeModel)
		)
	...
	try:
		...
		app.statusBar().showMessage(unavailable_message, 5000)
		return
	from ferrum_qt.models.document_session import PersistentOperationRequest
