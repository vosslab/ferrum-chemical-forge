...
pub(crate) struct DirectGlycosidicHaworthStyleV1 {
    paint: Paint,
...
pub(crate) fn resolve_direct_glycosidic_haworth_style_v1(
...
pub enum DepictionError {
    ...
    Render(#[from] ferrum_render::RenderError),
}
...
pub(crate) fn render_document_projection_v1(
    projection: &DocumentProjectionV1,
    profile: &DepictionProfileV1,
