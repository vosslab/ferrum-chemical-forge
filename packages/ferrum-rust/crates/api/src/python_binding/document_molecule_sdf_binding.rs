...
use ferrum_document::{
    ...
    publish_document_molecule_sdf_v1 as publish_sdf_receipt, DocumentMoleculeSdfErrorV1,
    DocumentMoleculeSdfPublicationErrorV1, DocumentMoleculeSdfRequestV1, DocumentMoleculeSdfV1,
};
