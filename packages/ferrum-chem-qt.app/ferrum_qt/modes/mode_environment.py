...
class ModeEnvironment:
	...
	def undo_stack(self) -> object:
		...
		return ferrum_qt.canvas.scene_queries.find_undo_stack(self._view)
	...
	def find_molecule_for_atom(self, atom_model: object) -> object:
		...
		"""
		return ferrum_qt.canvas.scene_queries.find_molecule_for_atom(
	...
	def find_molecule_for_bond(self, bond_model: object) -> object:
		...
		Returns:
			MoleculeModel or None.
		"""
		return ferrum_qt.canvas.scene_queries.find_molecule_for_bond(
	...
	def find_connected_bond_items(self, atom_model: object) -> list:
		...
		"""
		return ferrum_qt.canvas.scene_queries.find_connected_bond_items(
