"""Bridge between OASA chemistry objects and Ferrum-Qt model wrappers."""
...
def legacy_atom_text_bounds(
	...
	from ferrum_qt.canvas.items import primitive_ops_painter
...
def _legacy_bond_label_targets(
		atom_models: tuple[ferrum_qt.models.atom_model.AtomModel, ferrum_qt.models.atom_model.AtomModel],
...
def read_codec_file(
		...
		file_obj: object,
		**kwargs,
		) -> list[ferrum_qt.models.molecule_model.MoleculeModel]:
