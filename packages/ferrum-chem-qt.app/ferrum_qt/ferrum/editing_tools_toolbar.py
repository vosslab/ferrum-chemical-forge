"""Editing-tool action client for the ordinary Ferrum product window."""
...
class FerrumNativeEditingToolsToolbar(PySide6.QtWidgets.QToolBar):
	"""Project existing Ferrum pointer actions without creating a tool owner."""
	...
	def minimumSizeHint(self) -> PySide6.QtCore.QSize:
		"""Let Ferrum Qt overflow keep a narrow window usable."""
