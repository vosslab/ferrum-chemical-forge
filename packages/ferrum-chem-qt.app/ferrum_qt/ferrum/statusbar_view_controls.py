"""Accessible status-bar clients for window-owned Ferrum View actions."""
...
class FerrumNativeStatusBarViewControls(PySide6.QtWidgets.QWidget):
	...
	def __init__(
		...
		self._zoom_slider.setRange(
			ferrum_qt.ferrum.graphics_view.ZOOM_PERCENT_MINIMUM,
			ferrum_qt.ferrum.graphics_view.ZOOM_PERCENT_MAXIMUM,
		)
		self._zoom_slider.setSingleStep(
			ferrum_qt.ferrum.graphics_view.ZOOM_PERCENT_STEP,
		)
