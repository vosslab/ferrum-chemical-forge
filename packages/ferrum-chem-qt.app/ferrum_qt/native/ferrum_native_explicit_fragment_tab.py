"""Private Rust explicit-fragment seam for one native document tab."""
...
class FerrumNativeExplicitFragmentTabMixin:
	...
	def create_explicit_fragment_v1(self, expected_revision: int,
		...
		if (
			...
			raise TypeError("native fragment creation requires exact frozen inputs")
		if (
			...
			raise ValueError("native fragment creation requires distinct durable members")
