"""Chemistry view with zoom and pan for the Ferrum-Qt canvas."""
...
from ferrum_qt.canvas.scene import ChemScene  # noqa: F401 (used in type hints)
...
class ChemView(PySide6.QtWidgets.QGraphicsView):
	...
	def zoom_to_content(self) -> None:
		...
		chem_types = (
			...
			ferrum_qt.canvas.items.arrow_item.ArrowItem,
			ferrum_qt.canvas.items.text_item.TextItem,
			ferrum_qt.canvas.items.mark_item.MarkItem,
		)
