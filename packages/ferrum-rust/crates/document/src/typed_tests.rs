...
<cdml xmlns="urn:ferrum:cdml" version="26.07" type="normal">
  ...
  <molecule id="m1" name="probe">
    ...
    <fragment id="f1" type="linear_form"><name>linear_form</name><bond id="b1"/><vertex id="a1"/><property name="bond_length" value="40" type="IntType"/></fragment><display-form><future-local id="display-opaque">keep</future-local></display-form><user-data><vendor-data id="user-opaque">keep</vendor-data></user-data>
  </molecule>
