"""Rotation gesture behavior composed by the native pointer-tool host."""
...
class FerrumNativeTransformGesturesMixin:
	...
	def _start_rotation_gesture(
			self,
			intent: ferrum_qt.native.ferrum_native_line_tool_intent._LineGestureIntent,
	...
	def _complete_rotation_gesture(
		...
		self._finish_line_gesture(
			intent, self.tr("Rotated selected Rust-native atoms; drag again or press Esc."),
		)
