"""Qt GUI event simulation parity test for Ferrum-Qt."""
...
def test_qt_gui_event_simulation_delete(main_window: object) -> None:
	...
	assert isinstance(draw_mode, ferrum_qt.modes.draw_mode.DrawMode)
	...
	assert isinstance(edit_mode, ferrum_qt.modes.edit_mode.EditMode)
	...
	assert isinstance(
		...
		ferrum_qt.modes.draw_mode.DrawMode,
