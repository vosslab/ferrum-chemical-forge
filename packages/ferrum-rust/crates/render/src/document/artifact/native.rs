...
use crate::{
    DocumentRenderOutcomeV1, PdfRenderError, PngBackgroundV1, PngPixelSizeV1, PngRenderError,
    SvgOutputBudgetV1, SvgRenderError, render_document_plan_to_pdf_v1,
    render_document_plan_to_png_v1, render_document_plan_to_svg_with_budget_v1,
};
use ferrum_document::{
...
use crate::document::observation::derive_render_observation_from_accepted_operation_v1;
use crate::{
    DocumentRenderPlanCompositionError, LOCAL_PDF_COMPLETED_BYTES_V1,
    LOCAL_PDF_DRAW_PATH_COMMANDS_V1, LOCAL_PDF_PLAN_ITEMS_V1, LOCAL_PNG_ENCODED_BYTES_V1,
    LOCAL_PNG_RAW_RGBA_BYTES_V1, LOCAL_SVG_COMPLETED_BYTES_V1, RenderObservationError,
...
pub fn prepare_document_native_artifact_v1(
    ...
    let render_observation = derive_render_observation_from_accepted_operation_v1(observation)?;
