"""Abstract base mode for Ferrum-Qt interaction modes."""
...
import ferrum_qt.modes.mode_environment
...
class BaseMode(PySide6.QtCore.QObject):
	...
	def __init__(self, view: object, parent: PySide6.QtCore.QObject | None = None) -> None:
		...
		self._view = view
		self._env = ferrum_qt.modes.mode_environment.ModeEnvironment(view)
		self._name = "Base"
