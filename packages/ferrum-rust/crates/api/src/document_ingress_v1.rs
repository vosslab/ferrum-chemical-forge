...
mod tests {
    ...
    use ferrum_document::{XmlBudgetError, XmlInputError};
    ...
    fn budget(bytes: usize) -> ferrum_document::XmlInputBudgetV1 {
        ferrum_document::XmlInputBudgetV1 {
        ...
        assert!(
            matches!(
                ...
                DocumentIngressErrorV1::Cdsvg {
                    source: ferrum_document::CdsvgExtractionError::PayloadInput(
                        XmlInputError::Budget(XmlBudgetError::Utf8Bytes { limit: 1, .. })
                    ),
                    ..
                }
            ),
