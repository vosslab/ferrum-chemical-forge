# M8 typed versus opaque assignment
...
- Identity allocation, reference validation, and mutation. M7 explicitly deferred
  ...
  [m7_document_identity_ordering.md](m7_document_identity_ordering.md).
- Byte-level fidelity. Serialization fidelity remains the M6 structural contract
  in [m6_xml_storage_fidelity.md](m6_xml_storage_fidelity.md). Typing an element
...
- the lexical QName exactly as written, including its prefix or its absence;
...
[m7_document_identity_ordering.md](m7_document_identity_ordering.md). Being
