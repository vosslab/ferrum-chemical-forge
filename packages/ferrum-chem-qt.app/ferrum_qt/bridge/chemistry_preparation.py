...
def molecule_insertion_proposal(value: object) -> MoleculeInsertionProposal | None:
	...
	if isinstance(value, ferrum_qt.bridge.worker.PreparedMoleculeInsertion):
...
def create_text_molecule_insertion_worker(
	...
	return ferrum_qt.bridge.worker.TextMoleculeInsertionWorker(
...
def text_import_failure_facts(value: object) -> TextImportFailureFacts:
	...
	if isinstance(value, ferrum_qt.bridge.worker.TextImportPreparationError):
