...
def build_qss(theme_name: str) -> str:
	...
	qss += f"  background-color: {ribbon['surface']};"
	qss += f"  border-bottom: 1px solid {ribbon['group_border']};"
	...
	qss += "  text-align: left;"
	qss += "}"
	qss += "QToolButton[ribbonPresentation='compact'][ribbonGroup='true'],"
	qss += "QToolButton[ribbonPresentation='compact'] {"
	qss += "  padding: 0px;"
	qss += "  text-align: center;"
	qss += "}"
	qss += "QToolButton[ribbonControlCaptionVisible='true'] {"
	qss += "  padding: 0px 0px 10px 0px;"
	qss += "}"
	qss += "QLabel[ribbonControlCaption='true'] {"
	qss += f"  color: {ribbon['button_fg']};"
	qss += f"  font-size: {metrics.compact_caption_font_size}px;"
	qss += "  font-weight: 600;"
	qss += "  background-color: transparent;"
	qss += "}"
	qss += "QToolButton[ribbonPresentation='standard'] QLabel[ribbonControlCaption='true'] {"
	qss += "  font-size: 8px;"
	qss += "}"
	qss += "QToolButton[ribbonPresentation='large'] QLabel[ribbonControlCaption='true'] {"
	qss += "  font-size: 10px;"
	qss += "}"
	qss += "QToolButton[ribbonPresentation='standard'] {"
	qss += "  padding: 1px 3px;"
	qss += "  font-size: 10px;"
	qss += "  text-align: center;"
	qss += "}"
	qss += "QToolButton[ribbonPresentation='large'] {"
	qss += "  padding: 2px 6px;"
	qss += "  font-size: 10px;"
	qss += "  text-align: center;"
	qss += "}"
