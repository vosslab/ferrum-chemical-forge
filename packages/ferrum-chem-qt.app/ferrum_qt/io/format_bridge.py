...
def import_file(file_path: str) -> list:
	...
	capability = ferrum_qt.io.import_capabilities.capability_for_extension(ext)
	...
	with open(file_path, "r") as f:
		results = ferrum_qt.bridge.oasa_bridge.read_codec_file(
...
def get_supported_import_formats() -> dict:
	...
	return {
		...
		for capability in ferrum_qt.io.import_capabilities.all_import_capabilities()
