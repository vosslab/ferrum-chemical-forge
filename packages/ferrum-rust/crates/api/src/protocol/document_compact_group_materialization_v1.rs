...
use ferrum_document::{
    ...
    SessionOperation, SessionOperationError, SessionOperationOutcomeV1,
...
> {
    ...
    let compact_group_id = parse_document_object_id(&request.compact_group_id, "compact_group_id")?;
